const Hero = () => {
    return (
        <section className="bg-[#939393] text-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 py-16 text-center md:text-left">
                {/* Top Line */}
                ...
                <p className="text-gray-200 mb-8">
                    ...
                    sit orci sem. Ultrices adipiscing dictumst purus convallis. Convallis
                    imperdiet risus turpis turpis molestie erat viverra. Amet turpis nunc
                    facilisis turpis dui cras nunc.
                </p>
