    ...
    return (
        <section className="bg-gradient-to-b from-gray-50 to-[#F7F8FB]">
            <div className="container mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 py-14 md:py-16">
                <div className="">
                    <h2 className="text-3xl text-center sm:text-4xl md:text-5xl font-bold text-[#0B1F3A] leading-tight">
                ...
                <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                    {/* Card 1 */}
                    <motion.div initial={{ y: 16, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.45, ease: "easeOut" }} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
                    ...
                    {/* Card 2 */}
                    <motion.div initial={{ y: 16, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, ease: "easeOut" }} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
                        <Quote className="w-6 h-6 text-cyan-500" />
                        <p className="text-gray-700 mt-3">
                    ...
                    {/* Card 3 */}
                    <motion.div initial={{ y: 16, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.55, ease: "easeOut" }} className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 hover:shadow-md transition-shadow">
                        <Quote className="w-6 h-6 text-cyan-500" />
                        <p className="text-gray-700 mt-3">
