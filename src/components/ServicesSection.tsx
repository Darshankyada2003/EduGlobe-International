...
const services = [
  { title: "Student Visa", image: "/service1.jpg" },
  { title: "Visa Consultation", image: "/service2.jpg"   },
  { title: "Document Preparation", image: "/service3.jpg" },
  { title: "Visa Application", image: "/service4.jpg" }, 
  { title: "Employment Visa", image: "/service5.jpg" },
  { title: "Tourist Visa", image: "/service6.jpg" },
];
    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 py-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {services.map((service) => (
          ...
          >
            <div className="absolute inset-0 bg-[#0B1F3A]/5 group-hover:bg-[#0B1F3A]/10 transition-colors" ><img src={service.image} alt={service.title} className="w-full h-full object-cover" /></div>
